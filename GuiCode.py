...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.RelPhaseScroll = QtGui.QScrollBar(self.FT3)
        self.RelPhaseScroll.setGeometry(QtCore.QRect(0, 260, 160, 16))
        self.RelPhaseScroll.setMinimum(-100)
        self.RelPhaseScroll.setMaximum(100)
        self.RelPhaseScroll.setSingleStep(1)
        self.RelPhaseScroll.setPageStep(5)
        self.RelPhaseScroll.setOrientation(QtCore.Qt.Horizontal)
        self.RelPhaseScroll.setObjectName(_fromUtf8("RelPhaseScroll"))
        self.RelPhaseEdit = QtGui.QLineEdit(self.FT3)
        self.RelPhaseEdit.setGeometry(QtCore.QRect(190, 260, 61, 20))
        self.RelPhaseEdit.setObjectName(_fromUtf8("RelPhaseEdit"))
